...
public class PoweredFurnaceContainer extends Container {
    ...
    public PoweredFurnaceContainer(int id, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        super(ModBlocks.POWEREDFURNACE_CONTAINER, id);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), player, ModBlocks.POWEREDFURNACE);
    }
